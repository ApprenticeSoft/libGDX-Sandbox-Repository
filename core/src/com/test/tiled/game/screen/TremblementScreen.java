...
public class TremblementScreen extends InputAdapter implements Screen{
	...
	public TremblementScreen(final MyGdxGame gam){
		game = gam;
        ...
        vertexShader = Gdx.files.internal("Shaders/vTremblement.glsl").readString();
        fragmentShader = Gdx.files.internal("Shaders/fTremblement.glsl").readString();
	...
	public void render(float delta) {
    	...
    	// -----------------------------
		shaderProgram.begin();
        shaderProgram.setUniformf("u_distort", MathUtils.random(0.04f), MathUtils.random(0.04f), 0);
        shaderProgram.end();
        // -----------------------------
    	//SHADER FIN
    	// -----------------------------
