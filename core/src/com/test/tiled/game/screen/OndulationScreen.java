...
public class OndulationScreen extends InputAdapter implements Screen{
    ...
    private float amplitudeWave = 0.15f;
	private float angleWave = 0.0f;
	private float angleWaveSpeed = 0.4f;
	private float dt = 0;
    
	public OndulationScreen(final MyGdxGame gam){
		game = gam;
        ...
        vertexShader = Gdx.files.internal("Shaders/vOndulation.glsl").readString();
        fragmentShader = Gdx.files.internal("Shaders/fOndulation.glsl").readString();
	...
	public void render(float delta) {
        ...
        angleWave = dt * 5 * angleWaveSpeed;
        if(angleWave > Math.PI*2)
        	dt = 0;
        /*
